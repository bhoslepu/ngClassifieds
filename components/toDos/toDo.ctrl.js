(function(){
    ...
    angular.module('ngClassifieds').controller('toDoCtrl',['$scope' ,'$log' ,'$filter', function($scope ,$log ,$filter,moment ){
    ...
    $scope.todoList = (localStorage.getItem('todoList')!==null) ? JSON.parse($scope.saved) : [ {text: 'Learn AngularJS', done: false, dateTime: new Date()}, {text: 'Build an Angular app', done: false, dateTime: new Date()} ];    
